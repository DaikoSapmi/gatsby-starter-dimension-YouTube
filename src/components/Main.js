...
import contactCard from '../images/RuneFjellheim.vcf';
    ...
    return (
      ...
      >
        ...
        >
          ...
          <p>Spesialitehtat: Árktalaš politihkkagažaldagat, álgoálbmotpolitihkkaovddideapmi, máŋggabealát šiehtadallamat, Dálkkádatrievdangažaldagat ja Sámi gažaldagat. Logaldallamiid ja ovdanbuktimiid lea vejolaš diŋgut sihke digitálalaččat ja persovnnalaččat. <a href={contactCard} download>Visitkoarta</a></p>
          {close}
        </article>
        ...
        >
          ...
          <p>Spesialitet er prosessledelse, utredninger innenfor feltet samiske rettigheter, Arktis og urfolksspørsmål. I tillegg tilbys foredrag om samme temaer både digitalt og i egen person. <a href={contactCard} download>Visittkort</a></p>
          {close}
        </article>
        ...
        >
          ...
          <p>Specialties: Arctic Policy Issues, Indigenous Peoples' Policy Development, Multilateral negotiations, Climate Change Issues and Sámi Issues. Lectures and presentations can be held both digitally and in person. <a href={contactCard} download>Visitkoarta</a></p>
          {close}
        </article>
