    ...
    return (
      ...
      >
        ...
        >
          ...
          <p>Spesialitet er prosessledelse, utredninger innenfor feltet samiske rettigheter, Arktis og urfolksspørsmål. I tillegg tilbys foredrag om samme temaer både digitalt og i egen person. <a href="https://drive.google.com/file/d/1VLiJ1CX3DVi974f6RxC5AoCAHDnVCOrm/view?usp=sharing" download>Visittkort</a></p>
          {close}
        </article>
        ...
        >
          ...
          <p>Specialties: Arctic Policy Issues, Indigenous Peoples' Policy Development, Multilateral negotiations, Climate Change Issues and Sámi Issues. Lectures and presentations can be held both digitally and in person. <a href="https://drive.google.com/file/d/1VLiJ1CX3DVi974f6RxC5AoCAHDnVCOrm/view?usp=sharing" download>Business Card</a></p>
          {close}
        </article>
        ...
        <div id="kontakt"></div>
          ...
          <span className="image main">
            <img src={pic03} alt="" style={{ width: '50%' }} />
          </span>
